...
public class DetailDailAdapter extends RecyclerView.Adapter<DetailDailAdapter.ViewHolder> {

    List<DetailDailModel> list;

    public DetailDailAdapter(List<DetailDailModel> list) {
        this.list = list;
    }
