...
public class FeaturedVerAdapter extends RecyclerView.Adapter<FeaturedVerAdapter.ViewHolder> {
    ...
    List<FeatureVerModel> list;

    public FeaturedVerAdapter(List<FeatureVerModel> list) {
        this.list = list;
    }
    ...
    public FeaturedVerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.feature_ver_item,parent,false));
