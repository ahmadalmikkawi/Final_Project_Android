package com.example.finalpro.ui.dailymeal;
...
import com.example.finalpro.adapter.DailyMealAdapter;
...
public class DailyMealFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        dailyMealModels.add(new DailyMealModel(R.drawable.coffe,"Coffee","39% OFF","Description Description","coffee"));
